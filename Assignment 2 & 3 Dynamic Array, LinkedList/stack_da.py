...
# Description: Assignment 3 - Stack Dynamic Array
...
class Stack:
    ...
    def push(self, value: object) -> None:
        """
        This method adds a new element to the top of the stack, implemented with O(1) amortized time complexity
        """
    ...
    def pop(self) -> object:
        ...
        object = self._da.get_at_index(self.size() - 1)
