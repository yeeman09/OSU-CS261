...
# Description: Assignment 3 - Stack Singly Linked List
...
class Stack:
    ...
    def push(self, value: object) -> None:
        """
        This method adds a new element to the top of the stack, making the element the head of the linked list.
